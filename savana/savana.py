...
def parse_args(args):
    ...
    run_parser.add_argument('--inv_artefact_distance', nargs='?', type=int, default=200, help='Maximum distance between alignment start/end to be considered an artefact when --keep_inv_artefact is not set (default=200)')
    ...
    to_parser.add_argument('--inv_artefact_distance', nargs='?', type=int, default=200, help='Maximum distance between alignment start/end to be considered an artefact when --keep_inv_artefact is not set (default=200)')
    ...
    if not subparser:
        ...
        global_parser.add_argument('--inv_artefact_distance', nargs='?', type=int, default=200, help='Maximum distance between alignment start/end to be considered an artefact when --keep_inv_artefact is not set (default=200)')
